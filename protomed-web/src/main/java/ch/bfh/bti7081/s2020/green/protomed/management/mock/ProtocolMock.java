...
import ch.bfh.bti7081.s2020.green.protomed.management.AppointmentManager;
...
public class ProtocolMock {
    ...
    public static List<Protocol> getProtocols() {
        ...
        // Protocols of Laura
        List<Appointment> lauraAppointments = AppointmentManager.getInstance().getAppointmentsByHealthVisitorID(laura.getPersonId());
        ...
        List<Appointment> gertrudAppointments = AppointmentManager.getInstance().getAppointmentsByHealthVisitorID(gertrud.getPersonId());
        ...
        // Protocols of Max
        List<Appointment> maxAppointments = AppointmentManager.getInstance().getAppointmentsByHealthVisitorID(max.getPersonId());
